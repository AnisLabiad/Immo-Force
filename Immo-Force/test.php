...
<h1 class="p-4 my-5 bg-dark text-danger text-center">Page Test</h1>
                ...
                <?php foreach ($homes as $home) : ?>
                    <tr class="table">
                        ...
                        <form action="delete.php" method="post" 
                            ...
                            <input hidden type="text" name="id_logement" value="<?= $home['id_logement'] ?>">
        ...
        <a href="create.php" class="btn btn-info d-block">Ajouter un logement</a>
    </main>
